...
# Apply changes to ~/.zshrc or ~/.bashrc
source ~/.bashrc
echo "please type: source ~/.bashrc if the above command doesnt work or using the one from your linux for example kali linux ~/.zshrc"
